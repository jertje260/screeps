export class RepairerRole {
    ...
    private static findSite(creep: Creep): void {
        ...
        let upgradables = _.filter(creep.room.find(FIND_STRUCTURES), (structure: AnyStructure) => structure.hits != structure.hitsMax && (structure.structureType === STRUCTURE_WALL || structure.structureType === STRUCTURE_RAMPART));
